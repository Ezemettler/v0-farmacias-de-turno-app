...
export const metadata: Metadata = {
  title: "Farmacias de turno hoy en Venado Tuerto | Web farmacias de turno",
  description:
    "Farmacias de turno hoy en Venado Tuerto. Información actualizada con direcciones, teléfonos y horarios.",
  alternates: {
    canonical: "/venado-tuerto",
  },
}

export default async function VenadoTuertoPage() {
  const currentDate = { dateString: hoyArgentinaHumano() }
  const turnos = await fetchTurnos("venado-tuerto")
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span className="text-foreground font-medium">Venado Tuerto</span>
        </nav>
      </div>
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          <div className="space-y-2">
            <h1 className="text-3xl md:text-4xl font-bold text-balance leading-tight">
              Farmacias de turno hoy en Venado Tuerto
            </h1>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-base mt-2">
                      Hoy no hay farmacias de turno registradas para Venado Tuerto. Por favor, consultá más tarde o
          ...
          <NearbyCities currentSlug="venado-tuerto" />
        </div>
      </main>
