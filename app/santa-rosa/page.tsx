...
export default async function SantaRosaPage() {
  ...
  const turnos = await fetchTurnos("santa-rosa")
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span className="text-foreground font-medium">Santa Rosa</span>
        </nav>
      </div>
      ...
      <main className="flex-1 container mx-auto px-4 pb-12">
        <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-base mt-2">
                      Hoy no hay farmacias de turno registradas para Santa Rosa. Por favor, consultá más tarde o
          ...
          <NearbyCities currentSlug="santa-rosa" />
        </div>
      </main>
