...
export default async function MoronPage() {
  ...
  const turnos = await fetchTurnos("moron")
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span className="text-foreground font-medium">Morón</span>
        </nav>
      </div>
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          <div className="space-y-2">
            <h1 className="text-3xl md:text-4xl font-bold text-balance leading-tight">
              Farmacias de turno hoy en Morón
            </h1>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-base mt-2">
                      Hoy no hay farmacias de turno registradas para Morón. Por favor, consultá más tarde o
          ...
          <NearbyCities currentSlug="moron" />
        </div>
      </main>
